...
(custom-set-variables
 ...
 '(package-selected-packages
   '(helm-gtags godoctor go-tag go-rename go-impl go-guru go-gen-test go-fill-struct go-eldoc ggtags flycheck-golangci-lint counsel-gtags counsel swiper ivy company-go go-mode flutter-l10n-flycheck unfill mwim flutter dart-server dart-mode ansi package-build shut-up epl git commander f dash s)))
(custom-set-faces
